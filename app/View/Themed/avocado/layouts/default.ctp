<?php 
	$cssArray = array('/Themed/avocado/css/chosen', '/Themed/avocado/css/bootstrap.min', '/Themed/avocado/css/theme/avocado', '/Themed/avocado/css/prism','/Themed/avocado/css/fullcalendar', '/Themed/avocado/css/bootstrap-responsive', '/Themed/avocado/css/custom.css','/Themed/avocado/css/libs/modernizr-2.5.3-respond-1.1.0.min');

	$jsArrayPreDOM = array('/Themed/avocado/js/charts/excanvas.min.js', '/Themed/avocado/js/charts/jquery.flot.js', '/Themed/avocado/js/jquery.jpanelmenu.min.js', '/Themed/avocado/js/jquery.cookie.js', '/Themed/avocado/js/avocado-custom-predom.js');

	$jsArrayPostDOM = array('/Themed/avocado/js/jquery.hotkeys.js', '/Themed/avocado/js/calendar/fullcalendar.min.js', '/Themed/avocado/js/jquery-ui-1.10.2.custom.min.js', '/Themed/avocado/js/jquery.pajinate.js', '/Themed/avocado/js/jquery.dataTables.min.js', '/Themed/avocado/js/charts/jquery.flot.time.js', '/Themed/avocado/js/charts/jquery.flot.pie.js', '/Themed/avocado/js/charts/jquery.flot.resize.js', '/Themed/avocado/js/bootstrap/bootstrap.min.js', '/Themed/avocado/js/bootstrap/bootstrap-wysiwyg.js', '/Themed/avocado/js/bootstrap/bootstrap-typeahead.js', '/Themed/avocado/js/jquery.easing.min.js', '/Themed/avocado/js/jquery.chosen.min.js', '/Themed/avocado/js/avocado-custom.js', '/Themed/avocado/js/custom.js');
?>	
<!DOCTYPE html>
...
<body>
	...
	<?php 
		if($this->Session->check('User')):
			echo $this->element('home/header_login');
		else: 
			echo $this->element('home/header_non_login');
		endif;
	?>
	<div class="container">
		<?php 
	...
	<footer class="footer">
		<?php 
		if($this->Session->check('User')):
			echo $this->element('home/footer_login');
		else: 
			echo $this->element('home/footer_non_login');
		endif;
		?>
	</footer>
